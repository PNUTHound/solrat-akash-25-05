          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-medium mb-2">Traits</h4>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span className="text-white/60">Trait Count</span>
                      <span className="font-medium">{nft.traits.length}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h4 className="text-lg font-medium mb-2">Utility</h4>
