        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              />
              <span className="text-2xl font-display font-bold gradient-text">SolRat</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/roadmap" className="text-white/70 hover:text-accent transition-colors">Roadmap</Link></li>
              <li><Link to="/tokenomics" className="text-white/70 hover:text-accent transition-colors">Tokenomics</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/nft" className="text-white/70 hover:text-accent transition-colors">NFT</Link></li>
              <li><Link to="/dao" className="text-white/70 hover:text-accent transition-colors">DAO</Link></li>
              <li><a href="https://pump.fun" className="text-white/70 hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">Pump.fun</a></li>
              <li><a href="https://solana.com" className="text-white/70 hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">Solana</a></li>
            </ul>
          </div>
